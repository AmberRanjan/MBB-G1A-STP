...
'User waits for 50 sec for the session to get expired'

Mobile.delay(50)

'VerifyElement Text for Authorisation Expired'
Mobile.verifyElementText(findTestObject('Object Repository/Sprint_4/M25SP3GMCP-40/13_VerifyElementText - Your Secure Verification authorisation has expired. Please perform the transaction again'), 
