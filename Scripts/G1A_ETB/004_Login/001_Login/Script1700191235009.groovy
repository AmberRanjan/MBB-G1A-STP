...
/*Mobile.getText(findTestObject('Object Repository/004_Login/25_Read_otp - Your OTP no. is 654622'), 0) 
//storing the otp inside a variable 
def otpText3 = Mobile.getText(findTestObject('Object Repository/004_Login/25_Read_otp - Your OTP no. is 654622'), 0)
...
'VerifyElementText when user is on Activate Secure 2 u screen'
Mobile.verifyElementText(findTestObject('Object Repository/004_Login/37.1_VerifyElementText - Approve transactions safely and quickly with a single tap using Secure2u'), 
    'Approve transactions safely and quickly with a single tap using Secure2u.')

'Take screenshot when user takes screenshot'
Mobile.takeScreenshot('Screenshots/004_Login/001_Login/20.1_Secure2UTransactionScren')

Mobile.takeScreenshot()

'User taps on What is Secure2U'
Mobile.tap(findTestObject('Object Repository/004_Login/37.2_UserTapsOn_WhatIsSecure2U - What is Secure2u'), 0)

Mobile.delay(3)

'Take screenshot whe user is navigated to another screen'
Mobile.takeScreenshot('Screenshots/004_Login/001_Login/20.2_UserOnWhatIsSecure2U_Screen')

Mobile.takeScreenshot()

'User taps on back button'
Mobile.tap(findTestObject('Object Repository/004_Login/37.3_UserTapsOnBackButton'), 0)

Mobile.delay(3)

'Takes screenshot when user navigates back to Activate secure2U screen'
Mobile.takeScreenshot('Screenshots/004_Login/001_Login/20.3_UserNavigatesBackToSecure2U_DetailScreen')

Mobile.takeScreenshot()

'User taps on Register Secure2U button'
Mobile.tap(findTestObject('Object Repository/004_Login/37.4_UserTapsOnRegisterSecure2U'), 0)
...
Mobile.takeScreenshot()
*/
if (Mobile.verifyElementText(findTestObject('Object Repository/004_Login/0001_VerifyElementText - You may now authorise your transactions securely via the app'), 
    'You may now authorise your transactions securely via the app.')) {
    Mobile.tap(findTestObject('Object Repository/004_Login/0002_UserTapsOnDone'), 0)
} else {
    Mobile.verifyElementText(findTestObject('Object Repository/004_Login/001_VerifyElementText - Registration successful'), 
        'Registration successful!')

    Mobile.takeScreenshot('Screenshots/004_Login/001_Login/27.1_RegistrationSuccessful')

    Mobile.takeScreenshot()

    Mobile.tap(findTestObject('Object Repository/004_Login/002_UserTapsOnLater - Later'), 0)
}
...
Mobile.tap(findTestObject('Object Repository/004_Login/002_UserTapsOnLater - Later'), 0)
*/
'VerifyElementText when User navigated back to Dashboard screen'
Mobile.verifyElementText(findTestObject('Object Repository/004_Login/003_VerifyElementText - Quick Actions'), 'Quick Actions')

'Take screenshot when user navigates to dashboard'
Mobile.takeScreenshot('Screenshots/004_Login/001_Login/27.2_UserNavigatedToDashboard')
