...
Mobile.tap(findTestObject('Object Repository/003_Create_G1A/Steps/OccupationDropdownStep2'), 0)
...
'User taps on Actors'
Mobile.tap(findTestObject('003_Create_G1A/Steps/Occupation - Actors'), 0)

Mobile.delay(2)

'Screenshot after user selects Actors'
Mobile.takeScreenshot('Screenshots/005_G1A_Form_Edit/28_Actors_Selected')

Mobile.takeScreenshot()

/*-----------------------------------------------------------------------------------------------------------------------------------*/
Mobile.clearText(findTestObject('Object Repository/003_Create_G1A/Steps/101_Clear_EmployerText - ADMIN MSIA'), 0)

'Take Screenshot after clearing employer text'
Mobile.takeScreenshot('Screenshots/005_G1A_Form_Edit/28.1_EmployerText_Cleared')

Mobile.takeScreenshot()

'User sets text to Spacial characters'
Mobile.setText(findTestObject('Object Repository/003_Create_G1A/Steps/102_UserSets_SpecialCharacter - e.g Maybank'), '!@#$%^&*((^%', 
    0)

'Take Screenshot after giving special characters value to Employer'
Mobile.takeScreenshot('Screenshots/005_G1A_Form_Edit/28.2_Special_CharactersSetFor_EmployerText')

Mobile.takeScreenshot()

'Verify Element Text for Invalid Employer name'
Mobile.verifyElementText(findTestObject('Object Repository/003_Create_G1A/Steps/103_VerifyElementText - Employer name is invalid'), 
    'Employer name is invalid.')

'User clears text'
Mobile.clearText(findTestObject('Object Repository/003_Create_G1A/Steps/104_ClearText_EmployerName'), 0)

'Take screenshot once the text is cleared for Employer field'
Mobile.takeScreenshot('Screenshots/005_G1A_Form_Edit/28.3_EmployerText_Cleared_Again')

Mobile.takeScreenshot()

'User sets text to 50 characters'
Mobile.setText(findTestObject('Object Repository/003_Create_G1A/Steps/105_SetText - e.g Maybank'), '12345678901234567890123456789012345678901234567890', 
    0)

'Take screenshot whenthe value is entered'
Mobile.takeScreenshot('Screenshots/005_G1A_Form_Edit/28.4_EmployerText_set_To_50_Characters')

Mobile.takeScreenshot()

'User gets text as 40 characters even after entering 50 characters as only 40 characters is allowed'
String val = Mobile.getText(findTestObject('Object Repository/003_Create_G1A/Steps/106_GetText - 12345678901234567890123456789012345678901234567890'), 
    0)

if (val.length() <= 40) {
    print(val)
} else {
    print('Incorrect character limit')
}

Mobile.clearText(findTestObject('Object Repository/003_Create_G1A/Steps/android.widget.EditText - 12345678901234567890123456789012345678901234567890'), 
    0)
...
Mobile.tap(findTestObject('003_Create_G1A/Steps/62.1_SOI_Dropdown'), 0)
